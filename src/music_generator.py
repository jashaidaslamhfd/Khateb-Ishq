"""AI-generated viral sad-poetry background music.

2026-08-19: Owner asked for the music you hear behind viral TikTok/YouTube
sad-poetry shorts — emotional piano + violin + rain ambience, unique to
EVERY video (no stock repetition, no Content ID claims, royalty-free).

Engine: ModelsLab text-to-music (MODELSLAB_API_KEY already in repo secrets).
Fallback: legacy mood-picked stock track — the pipeline NEVER blocks.
"""
import json
import os
import random
...
# ---------------------------------------------------------------------------
# Prompt crafting — viral sad-poetry bed template + theme words
# ---------------------------------------------------------------------------
_BASE_PROMPT = (
